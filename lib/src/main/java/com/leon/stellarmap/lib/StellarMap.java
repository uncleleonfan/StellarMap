package com.leon.stellarmap.lib;
...
public class StellarMap extends FrameLayout implements AnimationListener, OnTouchListener, OnGestureListener {
    ...
    private RandomLayout mHiddenGroup;
    ...
    private void init() {
        ...
        mHidenGroupIndex = -1;
        mShownGroupIndex = -1;
        mHiddenGroup = new RandomLayout(getContext());
        mShownGroup = new RandomLayout(getContext());

        addView(mHiddenGroup, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
        mHiddenGroup.setVisibility(View.GONE);
    ...
    public void setRegularity(int xRegularity, int yRegularity) {
        mHiddenGroup.setRegularity(xRegularity, yRegularity);
    ...
    private void setChildAdapter() {
        ...
        mHiddenGroup.setAdapter(mHidenGroupAdapter);
    ...
    public void setInnerPadding(int paddingLeft, int paddingTop, int paddingRight, int paddingBottom) {
        mHiddenGroup.setPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
    ...
    public void setGroup(int groupIndex) {
        switchGroup(groupIndex, false, mZoomInNearAnim, mZoomInAwayAnim);
    }
    ...
    private void switchGroup(int newGroupIndex, boolean playAnimation, Animation inAnim, Animation outAnim) {
        ...
        if (playAnimation) {
            ...
            mHiddenGroup.startAnimation(outAnim);
        } else {
            mHiddenGroup.setVisibility(View.GONE);
        }
    }
